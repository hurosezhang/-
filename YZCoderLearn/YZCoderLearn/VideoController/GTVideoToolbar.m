...
- (void)layoutWithModel:(id)model {
    ...
    _avatorImageView.image = [UIImage imageNamed:@"icon.bundle/home_selected@2x.png"];
    _nickLabel.text = @"即刻时间";
    
    _commentImageView.image = [UIImage imageNamed:@"icon.bundle/like_selected@2x.png"];
    _commentLabel.text = @"100";

    _likeImageView.image = [UIImage imageNamed:@"icon.bundle/page_selected@2x.png"];
    _likeLabel.text = @"25";

    _shareImageView.image = [UIImage imageNamed:@"icon.bundle/share_selected@2x.png"];
    _shareLabel.text = @"分享";
